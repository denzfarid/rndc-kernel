...
#define CONFIG_SHAKIRA_OVERCLOCK_MODULE 1
...
#define CONFIG_SHAKIRA_UNDERVOLT_MODULE 1
...
#define CONFIG_MD 1
#define CONFIG_LOCALVERSION "$(KERNEL_LOCAL_VERSION)-RnDc"
